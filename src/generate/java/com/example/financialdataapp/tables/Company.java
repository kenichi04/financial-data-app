...
public class Company extends TableImpl<CompanyRecord> {
    ...
    /**
     * The column <code>PUBLIC.COMPANY.EDINET_CODE</code>.
     */
    public final TableField<CompanyRecord, String> EDINET_CODE = createField(DSL.name("EDINET_CODE"), SQLDataType.VARCHAR(255).nullable(false), this, "");
    ...
    /**
     * The column <code>PUBLIC.COMPANY.SECURITY_CODE</code>.
     */
    public final TableField<CompanyRecord, String> SECURITY_CODE = createField(DSL.name("SECURITY_CODE"), SQLDataType.VARCHAR(255).nullable(false), this, "");

    /**
     * The column <code>PUBLIC.COMPANY.CORPORATE_NUMBER</code>.
     */
    public final TableField<CompanyRecord, String> CORPORATE_NUMBER = createField(DSL.name("CORPORATE_NUMBER"), SQLDataType.VARCHAR(255).nullable(false), this, "");
    ...
    public List<UniqueKey<CompanyRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.CONSTRAINT_63, Keys.CONSTRAINT_637, Keys.CONSTRAINT_6372);
    }
     ...
     * <code>PUBLIC.FINANCIAL_DOCUMENT</code> table
     */
    public FinancialDocumentPath financialDocument() {
        if (_financialDocument == null)
            _financialDocument = new FinancialDocumentPath(this, null, Keys.CONSTRAINT_764.getInverseKey());
